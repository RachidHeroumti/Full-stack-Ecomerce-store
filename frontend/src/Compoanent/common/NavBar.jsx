        ...
        bg-red-100 w-full'>
         <div className=' flex items-center py-2'>
            <div className=' flex md:hidden' >
               {<AiOutlineMenu size={20} className=' text-gray-800 px-2' onClick={() => { setNav(true) }} />}
            </div >
            <h1 className=' text-xl font-bold px-3 hidden xl:flex text-gray-800'>Shop Onlay</h1>
         ...
         <div className='text-gray-950 flex px-1 sm:px-5 items-center '>
            <div className=' hidden md:flex items-center  '>
               ...
               <a href='#about' className='  mx-5   rounded-lg
                hover:text-gray-50 hover:bg-red-500  p-1  text-center' >About</a>
               <a href='#shop' className=' mx-5  rounded-lg
            ...
            <button onClick={() => { goToCart(); }}
               ...
               <span className='md:flex hidden'></span><BsFillCartFill size={20} className='mx-2' />
            </button>
            <a href='/login' className='px-5 text-white  rounded-lg
               bg-red-500 hover:bg-red-600   text-center' >Login</a>
         </div>
         ...
         {nav ? <div className='max-w-[350px] h-screen fixed top-0 left-0 z-10 bg-gray-100 px-1 '>
            <div className=' bg-red-200 py-2 flex items-center justify-between '>
               <h1 className='lg:text-2xl text-gray-900 font-medium flex items-center'><FaUser size={20} className='mx-3' />
                  My Account </h1>
               <AiOutlineClose size={25} className='mx-2  text-red-600 md:text-2xl font-bold' onClick={() => { setNav(false) }} />
            </div>
          ...
          hover:text-gray-50 hover:bg-red-500   p-1  ' >Home</a>
                ...
                hover:text-gray-50 hover:bg-red-500  p-1  ' >About</a>
                  <a href='#shop' className='   rounded-lg
