...
function Hero() {
  ...
  return (
    ...
    <div className='max-w-[1640px] mx-auto  bg-red-200' id='home'>
      ...
      <div id='explore' className='p-1 bg-red-50 flex flex-col sm:my-12 my-4  sm:space-y-3 sm:pt-12'>
        ...
        <div className=' grid grid-cols-2 sm:grid-cols-3 md:grid-cols-6 gap-2  p-1 sm:p-4'>

          <div className=' bg-white rounded shadow-md flex flex-col items-center p-1 sm:p-4 justify-center'>
            <img src='https://images.pexels.com/photos/1043474/pexels-photo-1043474.jpeg?auto=compress&cs=tinysrgb&w=300' alt='img'
              className=' w-[100px] h-[100px] rounded-full  ' />
            <h1 className='  text-gray-950  text-center'>Men's </h1>
          ...
          <div className=' bg-white rounded shadow-md flex flex-col items-center p-1 sm:p-4 justify-center'>
            <img src='https://images.pexels.com/photos/16711632/pexels-photo-16711632/free-photo-of-camera-on-black-background.jpeg?auto=compress&cs=tinysrgb&w=300' alt='img'
              className=' w-[100px] h-[100px] rounded-full  ' />
            <h1 className='  sm:text-2xl text-gray-950 text-center p-2'>Technologies</h1>
            <p className=' text-sm sm:text-xl text-gray-600 p-1'>+100 available</p>
          ...
          <div className=' bg-white rounded shadow-md flex flex-col items-center p-1 sm:p-4 justify-center'>
            <img src='https://media.istockphoto.com/id/171224469/photo/canvas-shoes.jpg?b=1&s=612x612&w=0&k=20&c=U9NLTutbuQ_L3HABoaa9Bsb_U3iJYw1QmKCBe0H3KWM=' alt='img'
              className=' w-[100px] h-[100px] rounded-full  ' />
            <h1 className=' sm:text-2xl text-gray-950 text-center p-2'>Shoes</h1>
            <p className='text-sm sm:text-xl text-gray-600 p-1'>+170 available</p>
          ...
          <div className=' bg-white rounded shadow-md flex flex-col items-center p-1 sm:p-4 justify-center'>
            <img src='https://images.pexels.com/photos/2105493/pexels-photo-2105493.jpeg?auto=compress&cs=tinysrgb&w=300' alt='img'
              className=' w-[100px] h-[100px] rounded-full  ' />
            <h1 className='  sm:text-2xl text-gray-950 text-center  p-2'>Sports</h1>
            <p className='text-sm sm:text-xl text-gray-600 p-1'>+300 available</p>
          ...
          <div className=' bg-white rounded shadow-md flex flex-col items-center p-1 sm:p-4 justify-center'>
            <img src='https://images.pexels.com/photos/1036623/pexels-photo-1036623.jpeg?auto=compress&cs=tinysrgb&w=300' alt='img'
              className=' w-[100px] h-[100px] rounded-full  ' />
            <h1 className='  sm:text-2xl text-gray-950 text-center  p-2'>women's </h1>
            <p className='text-sm sm:text-xl text-gray-600 p-1'>+170 available</p>
          ...
          <div className=' bg-white rounded shadow-md flex flex-col items-center p-1 sm:p-4 justify-center'>
            <img src='https://images.pexels.com/photos/1599791/pexels-photo-1599791.jpeg?auto=compress&cs=tinysrgb&w=300' alt='img'
              className=' w-[100px] h-[100px] rounded-full  ' />
            <h1 className='  sm:text-2xl text-gray-950 text-center p-2'>Cuisine</h1>
            <p className='text-sm sm:text-xl text-gray-600 p-1'>+170 available</p>
