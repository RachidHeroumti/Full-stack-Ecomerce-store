  ...
  return (
    <div className='max-w-[1640] p-4 flex justify-center py-12'>
      <div className='w-[400px] p-5 bg-gray-50 shadow-lg rounded-md '>
        <h1 className=' text-2xl font-bold text-red-600 p-2'> Register</h1>
        <div>
          ...
          <button onClick={() => { OnRegister() }}
            className='rounded-xl w-full text-center font-bold mt-2 bg-red-500 hover:bg-red-600
              text-white  p-1'>
            Register
          </button>
          <div className='flex items-center justify-end py-2'>
            <span>
              Already have an account ? <Link to="/login"
                className=' px-2 text-red-600  font-bold'>Login</Link>
            </span>
          </div>
